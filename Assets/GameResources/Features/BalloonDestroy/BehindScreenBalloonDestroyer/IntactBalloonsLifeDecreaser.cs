namespace Balloons.Features.BalloonDestroy
{
    ...
    /// </summary>
    public class IntactBalloonsLifeDecreaser: IDisposable
    {
        ...
        public IntactBalloonsLifeDecreaser(BehindScreenBalloonsDestroyer behindScreenBalloonsDestroyer, [Inject(Id = GlobalGameValueType.Lifes)] GenericEventValue<int> lifesCount)
        {
